...
# Form implementation generated from reading ui file 'ventana_editar_pelicula.ui'
#
...
"font: 20pt \"Comic Sans MS\";")
        ...
        self.btn_guardar_cambios_pelicula = QtWidgets.QPushButton(self.centralwidget)
        self.btn_guardar_cambios_pelicula.setGeometry(QtCore.QRect(140, 540, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.btn_guardar_cambios_pelicula.setFont(font)
        self.btn_guardar_cambios_pelicula.setStyleSheet("color: rgb(255, 255, 255);")
        self.btn_guardar_cambios_pelicula.setObjectName("btn_guardar_cambios_pelicula")
        ...
        self.lbl_imagen.setGeometry(QtCore.QRect(330, 420, 121, 141))
        ...
        self.lbl_error_reparto.setGeometry(QtCore.QRect(450, 210, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        ...
        self.lbl_error_duracion.setGeometry(QtCore.QRect(450, 130, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        ...
        self.lbl_error_pais.setGeometry(QtCore.QRect(450, 170, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        ...
        self.lbl_error_titulo.setGeometry(QtCore.QRect(450, 50, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        ...
        self.lbl_error_sinopsis.setGeometry(QtCore.QRect(450, 290, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        ...
        self.lbl_error_genero.setGeometry(QtCore.QRect(450, 250, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        ...
        self.lbl_error_anio.setGeometry(QtCore.QRect(450, 90, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Actualiza los datos de la película:"))
        ...
        self.btn_guardar_cambios_pelicula.setText(_translate("MainWindow", "Guardar cambios"))
