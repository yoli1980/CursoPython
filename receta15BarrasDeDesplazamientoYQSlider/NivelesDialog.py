...
class NivelesDialog(object):
    def setupUi(self, NivelesDialog):
        ...
        NivelesDialog.resize(468, 351)
        self.lbl_nivel_azucar = QtWidgets.QLabel(NivelesDialog)
        self.lbl_nivel_azucar.setGeometry(QtCore.QRect(20, 30, 101, 16))
        font = QtGui.QFont()
        ...
        self.hsb_nivel_azucar.setGeometry(QtCore.QRect(140, 30, 281, 16))
        ...
        self.lbl_presion_arterial.setGeometry(QtCore.QRect(20, 70, 111, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.hsd_presion_arterial.setGeometry(QtCore.QRect(140, 70, 281, 22))
        ...
        self.lbl_nivel_colesterol.setGeometry(QtCore.QRect(210, 110, 121, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.vsd_nivel_colesterol.setGeometry(QtCore.QRect(370, 110, 22, 160))
        ...
        self.txt_resultado.setGeometry(QtCore.QRect(30, 300, 401, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, NivelesDialog):
        ...
        self.lbl_nivel_azucar.setText(_translate("NivelesDialog", "Nivel de azúcar:"))
        ...
        self.lbl_nivel_colesterol.setText(_translate("NivelesDialog", "Nivel de colesterol:"))
